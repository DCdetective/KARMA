...
class SAN(nn.Module):
    def __init__(self, seq_len, pred_len, enc_in, period_len=12, station_type='adaptive'):
        super().__init__()
    ...
    def denormalize(self, input, station_pred):
        ...
        if self.station_type == 'adaptive':
            ...
            return input
    def forward(self, batch_x, mode='norm', station_pred=None):
        if mode == 'norm':
